module.exports = {
  ...
  getValidation: (req, res) => {
    let validations = [
      ...
      "When you allow your light to shine, you subconsciouly give other people permission to do the same.",
    ];
    let randomIndex = Math.floor(Math.random() * validations.length);
    let randomValidations = validations[randomIndex];

    res.status(200).send(randomValidations);
  },
};
